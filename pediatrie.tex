...
\label{sec:orga2999eb}
\subsubsection{Rôle de l'ANSM/HAS}
\label{sec:org70637d0}
\begin{itemize}
...
\end{tabular}
\end{center}\footnotetext[3]{\label{orgcc30f1b}CYP1A1, CYP 3A PgP}
...
\label{sec:org4671b07}
\subsection{Croissance}
\label{sec:org1b3825d}
\begin{itemize}
